    ...
    <div className="space-y-6">
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="md:col-span-2">
            <FormCheckbox
              label={t('evolutionGoForm.sections.instance.syncHistory', { defaultValue: 'Sincronizar Histórico' })}
              checked={!!form.syncHistory}
              onChange={checked => onFormChange('syncHistory', checked)}
            />
          </div>
        </div>
      </FormSection>

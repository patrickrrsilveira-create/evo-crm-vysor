...
"Evolution Foundation", "Evolution" and "EvoNexus" are trademarks of
Evolution Foundation. The "evonexus" wordmark and the EvoNexus
logo are trademarks of Evolution Foundation.

## 1. Scope and purpose

This policy governs the use of EvoNexus trademarks and brand assets.
It is intended to protect users from confusion and to preserve the official
EvoNexus visual identity.

This policy applies to any use of:
(a) the product names and marks "Evolution Foundation", "Evolution" and "EvoNexus";
(b) the official logo and wordmark: the "evonexus" wordmark and any
    associated icon in neon green;
(c) the copyright line "© 2026 Evolution Foundation"; and
(d) any materials that implement or express the EvoNexus official look
...
2.1. You may truthfully refer to EvoNexus to describe that your software
...
EvoNexus that include EvoNexus brand assets, provided that you
comply with Section 3 and do not suggest endorsement beyond being an official
unmodified build.

2.3. You may use EvoNexus marks in nominative ways, such as
"based on EvoNexus", provided that the use is accurate and does not
create confusion.

## 3. Protected Visual Identity Elements (Brand Assets)

The following are the "Protected Visual Identity Elements":
(a) Product names and marks: "Evolution Foundation", "Evolution" and "EvoNexus";
(b) Official logo and wordmark: the "evonexus" wordmark and any associated icon;
...
EvoNexus brand assets.** If you distribute or publicly host any version
of the user interface that uses EvoNexus brand assets, you may not
remove, replace, modify, disable, or bypass any Protected Visual Identity Element.

4.2. **Modified UI must remove EvoNexus brand assets.**
...
(a) remove and replace all EvoNexus trademarks and brand assets from
    the user interface, product name display, and related marketing materials
    for that distribution; and
(b) choose a name and branding that are clearly distinct from EvoNexus.

4.3. **No endorsement.**
You may not use EvoNexus trademarks or brand assets in a way that
...
Any violation of this policy terminates your permission to use EvoNexus
brand assets. You must promptly cease use and remove EvoNexus trademarks

...
export default function GoogleCalendarGlobalPage() {
  ...
  return (
    <div className="h-full flex flex-col p-4">
      <BaseHeader
        title="Google Calendar (Global)"
        subtitle="Configuração global de credenciais OAuth do Google Calendar para todos os agentes."
        secondaryActions={[
          {
            label: 'Voltar',
        ...
        <Card className="max-w-2xl p-6">
          <div className="flex items-center gap-4 mb-6">
            <div className="p-3 bg-primary/10 rounded-full">
              <BrandIcon id="google-calendar" size={32} className="h-8 w-8" />
            </div>
            <div>
